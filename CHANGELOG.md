...
* module/workarounds: Drop unnecessary Beagle workaround [Alexandru]

# v3.0.4
## (2026-01-27)

* module: Fix x86 build [Alexandru Costache]

# v3.0.3
## (2026-01-26)

* module: Switch to using an Alpine base image [Alexandru Costache]
